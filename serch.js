const date = [
    {
        type: 'gifu',
        key_list: ['dinner', 'alcohol'],
        name: '飯処 雲隠レ',
        img: 'material/photo/list/001_motosu/store001/img001.png',
        key: ['ディナー', 'お酒'],
        place: '岐阜市',
        comment: 'お洒落で明るい創作料理の美味しいお店',
        link: 'shop-list/motosu.html#motosu-001',

        detail_path: 'material/photo/list/001_motosu/store001',
        detail_img: 7,
    ...
    },
{
    type: 'gifu',
        key_list: ['dinner', 'alcohol'],
            name: 'ひとめぼれ岐阜駅前店',
                img: 'material/photo/list/001_motosu/store002/img001.png',
                    key: ['ディナー', 'お酒'],
                        place: '岐阜市',
                            comment: '関西発のコスパ最強居酒屋！',
                                link: 'shop-list/motosu.html#motosu-002'
},
{
    type: 'tyuunou',
